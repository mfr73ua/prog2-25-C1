...
def exportar_png_desde_html(html_path: str, output_path: str, delay: int = 3) -> None:
    """
    Toma una captura de pantalla de un archivo HTML generado por folium.

    Parámetros:
    -----------
    html_path : str
        Ruta al archivo HTML local (debe empezar por 'file://').

    output_path : str
        Ruta donde se guardará la imagen PNG.

    delay : int
        Tiempo de espera en segundos para que se cargue el mapa antes de capturar.
    """
